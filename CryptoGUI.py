...
tab_control.add(tabLanguages, text='Languages', padding='1', state='hidden')
...
tab_control.add(tabFunctions, text='Functions', padding='1', state='hidden')

tabLogic = ttk.Frame(tab_control)
tab_control.add(tabLogic, text='Logic', padding='1', state='hidden')
...
class InitAbout:
    def __init__(self):
        ...
        AboutLine5 = Label(tabAbout, text="Last modified on: 2019-01-27")
